...
if has("gui_running")
	...
	:hi LineNr guifg=#666666 guibg=#070914
	:hi VertSplit guibg=#c2bfa5 guifg=grey40 gui=none
	:hi Folded guifg=#eeeeee guibg=black
	...
	:hi CommentDoc guifg=grey45 guibg=black gui=italic
	:hi CommentDocTags guifg=grey50 guibg=black
